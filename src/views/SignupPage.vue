      ...
      <form @submit.prevent="onSignup()">
        <div class="mb-3 mx-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control shadow" placeholder="Marcia Polo" required="required" v-model.trim="username" />
          </div>
        </div>
        <div class="mb-3 mx-4">
          <div class="form-group">
            <label class="mb-2">Email</label>
            <input type="text" class="form-control shadow" placeholder="marcia@polo.com" required="required"  v-model.trim="email" />
        ...
        <div class="mb-3 mx-4">
          <div class="form-group">
            ...
            <input type="password" class="form-control shadow" placeholder="••••••••" required="required" v-model.trim="password" />
